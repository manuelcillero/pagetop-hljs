...
use crate::{config, HljsLang, HljsMode, HljsTheme};
...
pub trait HljsContext {
    ...
    /// least one language to load the *highlight.js* library. Each [`Snippet`](crate::Snippet)
    /// component automatically adds its required language.
